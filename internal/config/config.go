...
func DefaultConfig() *Config {
	return &Config{
		...
		PushTypes:   []string{"permission", "codex_response", "tool_use", "session_status"},
...
func ConfigDir() (string, error) {
	...
	return filepath.Join(home, ".codex-go"), nil
}
...
// ParseEnvVars parses the CodexEnvVars dotenv string into KEY=VALUE pairs.
// Blank lines and # comments are skipped.
func (c *Config) ParseEnvVars() []string {
	return ParseDotEnv(c.CodexEnvVars)
}
